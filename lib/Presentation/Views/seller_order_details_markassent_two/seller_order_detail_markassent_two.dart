import 'package:contr_project/Presentation/Views/chat_room/chat_room.dart';
import 'package:contr_project/Presentation/Views/seller_order_list_one/seller_order_list_one.dart';
import 'package:flutter/cupertino.dart';
import 'package:flutter/material.dart';

class SellerOrderDetailMarkassentTwo extends StatelessWidget{
  @override
    ...
    Widget _getBody(BuildContext context){
      return Column(
        ...
        children: [
          ...
          Padding(
            ...
            child: ClipRRect(
                ...
                child: Image.asset('assets/images/deliverpicfive.png')),
          ),
       ...
       Navigator.push(context, MaterialPageRoute(builder: (context) => ChatRoom(),));
                      ...
                      child: Text('Leave a Review', style: TextStyle(fontSize: 16,
                        fontWeight: FontWeight.w400, color: Color(0xffFFFFFF),
                      ),
                      ),
                    ),
