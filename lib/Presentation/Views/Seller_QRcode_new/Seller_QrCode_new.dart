import 'package:contr_project/Presentation/Views/Seller_QRcode_main/Seller_QRcode_main.dart';
import 'package:contr_project/Presentation/Views/Seller_create_QR/Seller_create_QR.dart';
import 'package:flutter/cupertino.dart';
import 'package:flutter/material.dart';

class SellerQrcodeNew extends StatelessWidget {
  @override
             ...
             children: [
               ...
               Container(
                 ...
                 child: ElevatedButton(
                   onPressed: () {
                     Navigator.push(context, MaterialPageRoute(builder: (context) => SellerQrcodeMain(),));
                   },
                   child: Text(
                     'Create QR Code',
                     style: TextStyle(
