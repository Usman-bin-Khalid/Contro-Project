...
import 'package:contr_project/Presentation/Views/seller_item_varients_three/seller_item_varients_htree.dart';
import 'package:flutter/cupertino.dart';
import 'package:flutter/material.dart';

class SellerItemVarientsTwo extends StatelessWidget{
  @override
                ...
                child: Container(
                  ...
                  child: Row(
                    ...
                    children: [
                      Container(
                        width: 165,
                        child: ElevatedButton(onPressed: (){}, child: Text('Add Variation', style: TextStyle(fontSize: 16,
                      ...
                      Container(
                        ...
                        child: ElevatedButton(onPressed: (){
                          Navigator.push(context, MaterialPageRoute(builder: (context) => SellerItemVarientsthree(),));
