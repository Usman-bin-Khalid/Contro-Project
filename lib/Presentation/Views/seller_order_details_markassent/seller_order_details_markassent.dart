import 'package:contr_project/Presentation/Views/seller_order_details_markassent_two/seller_order_detail_markassent_two.dart';
import 'package:contr_project/Presentation/Views/seller_order_details_two/seller_order_details_two.dart';
import 'package:contr_project/Presentation/Views/seller_order_list_one/seller_order_list_one.dart';
import 'package:flutter/cupertino.dart';
import 'package:flutter/material.dart';

class SellerOrderDetailsMarkassent extends StatelessWidget{
  @override
      ...
      children: [
        ...
        Padding(
          ...
          child: ClipRRect(
              ...
              child: Image.asset('assets/images/deliverypicfour.png')),
        ),
            ...
            children: [
              Padding(
                ...
                child: Container(
                  ...
                  height:48,
                  child: ElevatedButton(onPressed: (){
                    Navigator.push(context, MaterialPageRoute(builder: (context) => SellerOrderDetailMarkassentTwo(),));
                  }, child: Center(
                    child: Text('Marked as Complete', style: TextStyle(fontSize: 16,
                      fontWeight: FontWeight.w400, color: Color(0xffFFFFFF),
                    ),
                    ),
                  ),
