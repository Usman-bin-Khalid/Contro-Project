import 'package:contr_project/Presentation/Views/seller_order_details/seller_order_details.dart';
      ...
      children: [
        ...
        Padding(
          ...
          child: ClipRRect(
              ...
              child: Image.asset('assets/images/deliverypic.png')),
        ),
            ...
            children: [
              Padding(
                ...
                child: Container(
                  ...
                  height:48,
                  child: ElevatedButton(onPressed: (){
                     Navigator.push(context, MaterialPageRoute(builder: (context) => SellerOrderDetails(),));
                  }, child: Center(
