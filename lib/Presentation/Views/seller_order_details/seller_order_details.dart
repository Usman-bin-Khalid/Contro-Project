       ...
       children: [
                 ...
                 child: Column(
                   ...
                   children: [
                     Container(
                       ...
                       }, child: Text('Open',style: TextStyle(fontSize: 9,
                           fontWeight: FontWeight.w400, color: Color(0xffFFFFFF)),
                         textAlign: TextAlign.center,
                       ),
                         style: ElevatedButton.styleFrom(backgroundColor: Color(0xffFFAA3C),
         ...
         Padding(
           ...
           child: ClipRRect(
               ...
               child: Image.asset('assets/images/deliverypic2.png')),
         ),
             ...
             children: [
               Padding(
                 ...
                 child: Container(
                   ...
                   height:48,
                   child: ElevatedButton(onPressed: (){
                     Navigator.push(context, MaterialPageRoute(builder: (context) => SellerOrderDetailsTwo(),));
                   }, child: Center(
                     child: Text('Print Packing List', style: TextStyle(fontSize: 16,
                       fontWeight: FontWeight.w400, color: Color(0xffFFFFFF),
                     ),
                     ),
                   ),
